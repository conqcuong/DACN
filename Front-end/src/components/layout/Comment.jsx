        ...
        <div className='cmt_body'>
            <div className='cmt_detail'>
                <div className='cmt_contentHeading'>
                    <div>
                        <h4>210 hỏi đáp</h4>
                        <p className='cmt_help my-3'>(Nếu thấy bình luận spam, các bạn bấm report giúp admin nhé)</p>
                    </div>
                </div>
                 <div className='cmtBox_cmtWrapper'>
                    ...
                    <div className='cmtBox_cmtContent'>
                        <div className='flex flex-wrap'>
                            <textarea id="message" rows="4" className="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500" placeholder="Bạn có thắc mắc gì trong khóa học này" value={newComment} 
                            onChange={(e) => setNewComment(e.target.value)}></textarea> 
                            <button onClick={sendMessage} className='mt-4 ml-auto text-14px px-4 py-2.5 bg-primary-colorrounded-2xl'>Bình luận</button>                       
                        </div>
                    </div>
                </div>
                {
                                ...
                                <div className='cmt_detail_comment' key={item.id}>
                                    <div className='shrink-0'>
                                        <div className='fallbackavt'>
                                            <img className='object-cover rounded-full w-[37.79px]' src={user.avaterimage} alt="User avaterimage" />
                                        </div>
                                    </div>
                                        ...
                                        <div className='relative'>
                                            <div className='inline-block max-w-full'>
                                                ...
                                                <div className='flex items-center justify-between'>
                                                    <span className='text-black inline-block text-14px font-semibold'>{user.fullname}</span>
                                                </div>
                                                <div className='cmt_Comentext'>
                                                    <div className='mt-2 font-normal text-[#292929] text-14px break-words leading-7'>
                                                        <p className='font-normal mt-1.5'>{item.comment}</p>
                                                    </div>
                                                </div>
                                                </div>
                                            </div>
