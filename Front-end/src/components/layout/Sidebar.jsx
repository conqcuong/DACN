    ...
    <>
        <div className='flex items-center flex-col px-2 sticky top-[74px] z-[8] w-[96px]'>
            ...
            <ul className='my-2.5'>
                ...
                <li><NavLink className='flex items-center justify-center rounded-2xl flex-col h-[72px] w-[72px] mt-1 hover:bg-[#f5f5f5]' to='/pages/ChatPage'><FaRocketchat className='w-5 h-5 text-[#404040]'/><span className='text-[11px] font-semibold mt-1 text-[#404040]'>Chat</span></NavLink></li>
            </ul>
        </div>
    </>
  )
