...
export const Sidebar = () => {
    return (
        <div className='bg-[#4E73DF] px-[25px] h-screen'>
            <Link to='/' className='px-[15px] py-[30px] flex items-center justify-center border-b-[1px] border-[#EDEDED]/[0.3]'>
            ...
            <div className='pt-[15px] border-b-[1px] border-[#EDEDED]/[0.3]'>
                ...
                <div className='flex items-center justify-between gap-[10px] py-[15px] cursor-pointer'>
                    <Link to={'/dashboard/pay'} className='flex items-center gap-[10px]'>
                        <RiBillFill color='white' /> <p className='text-[14px] leading-[20px] font-normal text-white'>History Payment</p>
                    </Link>
                    {/* <FaChevronRight color='white' /> */}
                </div>
            </div>
