...
public class StreamController {
    ...
    public String recordVideo() {
        try {
            ...
            String outputFilePath = "D:\\DACN\\Back-end\\SpringBootMicroserviceCourse-master\\ffmpeg-6.1-essentials_build\\bin\\record\\1234.mp4";
    ...
    public Mono<Stream> createStream(@RequestBody Stream stream) {
        try {
            ...
            String outputFilePath = "D:\\DACN\\Back-end\\SpringBootMicroserviceCourse-master\\ffmpeg-6.1-essentials_build\\bin\\record\\"+stream.getSecretkey()+".mp4";
